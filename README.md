...
<p align="center">
  <img src="assets/img/robogerio.gif" width="90" alt="Demonstração do RoboGério">
</p>
...
- Interface interativa inspirada em um terminal.
- Exercícios utilizando estruturas condicionais ("if", "else if" e "else").
- Feedback visual para cada resposta.
- Modal com instruções para o usuário.
- Barra de progresso/energia do Robogério.
- Animações e elementos visuais para tornar a experiência mais dinâmica.
